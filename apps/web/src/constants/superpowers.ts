...
export const SUPERPOWERS: Superpower[] = [
  ...
  { name: 'Reportes automaticos', subtitle: 'REPORTE SEMANAL SIN MOVER UN DEDO.', description: 'Cada lunes recibes un resumen: conversaciones, ventas, no-shows, tendencias. Directo a tu WhatsApp.', icon: FileBarChart, isActive: true },
